...
<script src="/static/jsjquery.js"></script>
<script src="/static/jspintuer.js"></script>
</head>
<body>
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="add.html"> 添加开课</a> </li>
        <li >搜索：</li>
        <li>系部
    ...
    <volist name="list" id="vo">
    	<tr>
	      <td style="text-align:center;"><input type="checkbox" name="id[]" value="" />
	       1</td>
	      <td>web应用开发</td>
	      <td>张小华</td>
	      <td>信工17201-17202</td>
	    ...
	    <tr>
	  	...
	  	<tr>
	  		<td style="text-align:left; padding-left: 52px;"><input type="checkbox" id="checkall"/>
		      全选 </td>
		    <td></td>
		    <td></td>
		    <td></td>
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">    
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入开课班级" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入学分" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入学时" />
          <div class="tips"></div>
        </div>
      </div>
