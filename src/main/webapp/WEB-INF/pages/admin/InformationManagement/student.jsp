...
<div class="panel admin-panel">
  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="add.html"> 添加学生</a> </li>
        <li >搜索：</li>
        <li>系部
  ...
  <table class="table table-hover text-left">
    ...
    <tr>
	  		<td style="text-align:left; padding-left: 49px;"><input type="checkbox" id="checkall"/>
		      全选 </td>
		    <td></td>
		    <td></td>
		    <td></td>
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">    
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入学生名" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入年级" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="title" data-validate="required:请输入班级" />
          <div class="tips"></div>
        </div>
      </div>
